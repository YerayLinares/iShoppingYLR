...
public class AddProductActivity extends AppCompatActivity {
    ...
    private Switch addswitch, gluten, lactosa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gluten = findViewById(R.id.addGluten);
        lactosa = findViewById(R.id.addLactosa);
        ...
        btnAdd.setOnClickListener(v -> {
            ...
            boolean tieneGluten = gluten.isChecked();
            boolean tienelactosa = lactosa.isChecked();
            ...
            if (!name.isEmpty() && !notes.isEmpty()) {
                ...
                newProduct.setGluten(tieneGluten);
                newProduct.setLactosa(tienelactosa);
