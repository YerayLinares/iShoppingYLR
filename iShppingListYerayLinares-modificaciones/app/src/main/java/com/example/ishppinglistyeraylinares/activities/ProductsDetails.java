...
public class ProductsDetails extends AppCompatActivity {
    ...
    private TextView tvName, tvNote, tvstate, tvid, tvGluten, tvLactosa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvGluten = findViewById(R.id.tvGlutendetail);
        tvLactosa = findViewById(R.id.tvLactosadetail);
        ...
        if (p != null) {
            ...
            if(p.isGluten()) {
                tvGluten.setText("Tiene Gluten");
            } else {
                tvGluten.setText("No tiene gluten");
            }

            if(p.isLactosa()) {
                tvLactosa.setText("Tiene Lactosa");
            } else {
                tvLactosa.setText("No tiene lactosa");
            }
        }
