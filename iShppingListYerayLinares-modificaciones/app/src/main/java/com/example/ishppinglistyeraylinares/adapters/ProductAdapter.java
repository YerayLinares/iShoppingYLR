...
public class ProductAdapter extends ArrayAdapter<Product> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(p.isGluten()) {
            convertView.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.gluten));
        ...
        if (p.isLactosa() && p.isGluten()) {
            convertView.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.lactogluten));
